...
static gint ett_enet_command = -1;
...
static void
dissect_enet_acknowledge(tvbuff_t *tvb, proto_tree *command_tree, gint *offset)
{
...
static void
dissect_enet_bandwidth_limit(tvbuff_t *tvb, proto_tree *command_tree, gint *offset)
{
...
static void
dissect_enet_throttle_configure(tvbuff_t *tvb, proto_tree *command_tree, gint *offset)
{
...
static void
dissect_enet_connect(tvbuff_t *tvb, proto_tree *command_tree, guint *offset)
{
    ...
    *offset += 4;
    ...
    /* Bandwidth, Throttle */
    dissect_enet_bandwidth_limit(tvb, command_tree, offset);
    dissect_enet_throttle_configure(tvb, command_tree, offset);
...
static void
dissect_enet_verify_connect(tvbuff_t *tvb, proto_tree *command_tree, guint *offset)
{
    /* TODO: start conversation between those 2 ENet peers */
    /* TODO: save connected peer IDs to conversation */
    /*conversation_t *conversation = conversation_new(pinfo->fd->num, &pinfo->src, &pinfo->dst, PT_UDP,
...
static void
dissect_enet_disconnect(tvbuff_t *tvb, packet_info *pinfo, proto_tree *command_tree, proto_tree *tree, gint *offset)
{
    /* Disconnect Data */
...
static void
dissect_enet_send_reliable(tvbuff_t *tvb, packet_info *pinfo, proto_tree *command_tree, proto_tree *tree, gint *offset)
{
...
static void
dissect_enet_send_fragment(tvbuff_t *tvb, packet_info *pinfo, proto_tree *command_tree, proto_tree *tree, gint *offset)
{
...
static void
dissect_enet_send_unsequenced(tvbuff_t *tvb, packet_info *pinfo, proto_tree *command_tree, proto_tree *tree, gint *offset)
{
    guint16 payload_length;
    tvbuff_t *tvb_payload;
    gint remaining;
...
static void
dissect_enet_send_unreliable_fragment(tvbuff_t *tvb, proto_tree *command_tree, gint *offset)
{
...
static void
dissect_enet_count(tvbuff_t *tvb, proto_tree *command_tree, gint *offset)
{
    /* TODO: Not supported yet!*/
    proto_tree_add_item(command_tree, hf_payload, tvb, *offset, -1, ENC_BIG_ENDIAN);
    *offset += tvb_captured_length_remaining(tvb, *offset);
...
static void
dissect_enet_command(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, gint *offset)
{
    ...
    proto_tree *command_tree = proto_tree_add_subtree_format(enet_tree, tvb,
        *offset, 0, ett_enet_command, &ti, "%s", commandName);
    ...
    *offset += 2;
    ...
    /* Dissect command */
    switch (command) {
    case 1: dissect_enet_acknowledge(tvb, command_tree, offset); break;
    case 2: dissect_enet_connect(tvb, command_tree, offset); break;
    case 3: dissect_enet_verify_connect(tvb, command_tree, offset); break;
    ...
    case 11: dissect_enet_throttle_configure(tvb, command_tree, offset); break;
    case 12: dissect_enet_send_unreliable_fragment(tvb, command_tree, offset); break;
    case 13: dissect_enet_count(tvb, command_tree, offset); break;
    default: break;
    }
...
static void
dissect_enet_header(tvbuff_t *tvb, packet_info *pinfo, gint *offset)
{
    guint8 sentTimeFlag;
    guint16 peerID;
...
dissect_enet(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
    ...
    //if (tree) {
    proto_item *ti = proto_tree_add_item(tree, proto_enet, tvb, offset, -1, ENC_NA);
    enet_tree = proto_item_add_subtree(ti, ett_enet_header);
    //}

    dissect_enet_header(tvb, pinfo, &offset);

    while (tvb_captured_length_remaining(tvb, offset) > 0) {
        dissect_enet_command(tvb, pinfo, tree, &offset);
    }
